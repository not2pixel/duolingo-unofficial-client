...
(() => {
  ...
  // src/errors.ts
  var DuolingoError = class extends Error {
    status;
    method;
    endpoint;
    retryAfter;
  ...
  var DuolingoAuthError = class extends DuolingoError {
  };
  var DuolingoHttpError = class extends DuolingoError {
  };
  var DuolingoParseError = class extends DuolingoError {
  };
  var DuolingoRateLimitError = class extends DuolingoHttpError {
  };
  var DuolingoConfigurationError = class extends DuolingoError {
  };
  ...
  var ENDPOINTS = {
    ...
    leaderboards: {
      currentWeekly: (id) => `/leaderboards/7d9f5dd1-8423-491a-91f2-2532052038ce/users/${encodeURIComponent(id)}?client_unlocked=true`
    },
    goals: {
      schema: (uiLanguage) => `/schema?ui_language=${encodeURIComponent(uiLanguage)}`,
      progress: (id, timezone, uiLanguage) => `/users/${encodeURIComponent(id)}/progress?timezone=${encodeURIComponent(timezone)}&ui_language=${encodeURIComponent(uiLanguage)}`
    },
    shop: {
  ...
  function allowedOrigins(baseUrls) {
  ...
  // src/schemas/user.ts
  var nullableString = external_exports.string().nullable().optional();
  var nullableNumber = external_exports.number().nullable().optional();
  var upstreamUserSchema = external_exports.object({
    id: external_exports.union([external_exports.string(), external_exports.number()]),
    username: external_exports.string().optional().default(""),
    name: nullableString,
  ...
  var levelSchema = external_exports.object({
    pathLevelMetadata: external_exports.object({ skillId: external_exports.string().optional() }).passthrough().optional(),
    pathLevelClientData: external_exports.object({ skillId: external_exports.string().optional() }).passthrough().optional()
  }).passthrough();
  var currentCourseSchema = external_exports.object({
    pathSectioned: external_exports.array(
      external_exports.object({
        units: external_exports.array(external_exports.object({ levels: external_exports.array(levelSchema).optional() }).passthrough()).optional()
      }).passthrough()
    ).optional()
  }).passthrough();
  var upstreamCourseResponseSchema = external_exports.object({
  ...
  var titleSchema = external_exports.object({ uiString: external_exports.string().optional() }).passthrough();
  var goalSchema = external_exports.object({
    goalId: external_exports.string(),
    badgeId: external_exports.string().nullable().optional(),
    category: external_exports.string().nullable().optional(),
    metric: external_exports.string().nullable().optional(),
    threshold: external_exports.number().nullable().optional(),
    title: titleSchema.nullable().optional()
  }).passthrough();
  var upstreamGoalSchemaResponse = external_exports.object({
    goals: external_exports.array(goalSchema).optional().default([]),
    badges: external_exports.array(external_exports.unknown()).optional().default([])
  }).passthrough();
  var progressValueSchema = external_exports.union([external_exports.number(), external_exports.object({ progress: external_exports.number().optional() }).passthrough()]);
  var upstreamGoalProgressResponse = external_exports.object({
    goals: external_exports.object({
      progress: external_exports.record(progressValueSchema).optional().default({})
    }).passthrough().optional(),
    badges: external_exports.object({
      earned: external_exports.array(external_exports.string()).optional().default([])
    }).passthrough().optional()
  }).passthrough();
  function mapGoalSchema(input) {
  ...
  function mapGoalProgress(input) {
  ...
  function buildGoalHeaders(token) {
  ...
  var rankingSchema = external_exports.object({
    user_id: external_exports.union([external_exports.string(), external_exports.number()]),
    ...
    score: external_exports.number().optional().default(0),
    rank: external_exports.number().nullable().optional(),
    picture: external_exports.string().nullable().optional(),
    avatar_url: external_exports.string().nullable().optional()
  }).passthrough();
  var upstreamLeaderboardSchema = external_exports.object({
    active: external_exports.object({
      cohort: external_exports.object({
        rankings: external_exports.array(rankingSchema).optional().default([])
      }).passthrough().optional()
    }).passthrough().optional()
  }).passthrough();
  ...
  function mapLeaderboard(input, currentUserId) {
  ...
  var LeaderboardsModule = class {
    ...
    async getCurrent() {
      ...
      const data = await this.client.request({ method: "GET", path, baseUrl: "leaderboards" });
      return this.client.parseSchema((input) => mapLeaderboard(input, id), data, path);
    }
  };

  // src/schemas/shop.ts
  var shopItemSchema = external_exports.object({
    id: external_exports.string(),
    name: external_exports.string().nullable().optional(),
    type: external_exports.string().nullable().optional(),
    currencyType: external_exports.string().nullable().optional()
  }).passthrough();
  var upstreamShopResponseSchema = external_exports.object({
    shopItems: external_exports.array(shopItemSchema).optional().default([])
  }).passthrough();
  function mapShopItems(input) {
  ...
  var DuolingoClient = class {
    ...
    constructor(config = {}) {
      ...
      const tokenOptions = {};
      if (config.token !== void 0) tokenOptions.token = config.token;
      if (config.tokenProvider !== void 0) tokenOptions.tokenProvider = config.tokenProvider;
    ...
    async request(options) {
      ...
      const token = authenticated ? await this.#tokenResolver.requireToken() : void 0;
      ...
      if (options.body !== void 0) transportRequest.body = options.body;
      if (options.signal !== void 0) transportRequest.signal = options.signal;
    ...
    /** @internal */
    async authTokenForInternalUse() {
      return this.#tokenResolver.requireToken();
    }
    parseSchema(mapper, input, endpoint) {
      try {
        return mapper(input);
      } catch (error) {
  ...
  // demos/userscript/src/gm-transport.ts
  ...
  var GmTransport = class {
    constructor(gmXmlHttpRequest) {
      this.gmXmlHttpRequest = gmXmlHttpRequest;
    }
    request(request) {
      return new Promise((resolve, reject) => {
        ...
        if (request.body !== void 0) options.data = JSON.stringify(request.body);
  ...
  // demos/userscript/src/demo.user.ts
  var state = {
    token: null,
    client: null,
    user: null,
  ...
  function getJwtFromCurrentPageCookie(cookie = typeof document === "undefined" ? "" : document.cookie) {
  ...
  function render(root) {
    ...
    status.textContent = state.status === "connected" ? "Connected" : state.status === "loading" ? "Loading profile..." : state.status === "error" ? state.error ?? "Error" : "Disconnected";
  ...
  async function connectFromPageCookie(root) {
  ...
  async function connectWithToken(root, token) {
